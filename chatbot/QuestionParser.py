...
@software: garner
@file: QuestionParser.py
@time: 2019/8/15 22:28
@desc:
'''
...
class QuestionParser(object):
    ...
    def transferQuestion2Sql(self, question_type, entities):
        '''
    ...
    def getAllQuestionSql(self, res_classify):
        ...
        for question_type in question_types:
            ...
            if question_type == 'disease_symptom':
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('disease'))

            elif question_type == 'symptom_disease':
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('symptom'))
                ...
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('food'))
                ...
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('drug'))

            elif question_type == 'disease_check':
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('disease'))

            elif question_type == 'check_disease':
                sql = self.transferQuestion2Sql(question_type, entity_dict.get('check'))
